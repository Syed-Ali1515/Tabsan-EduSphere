    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LicenseHash = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_license_state", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_module_status", x => x.Id);
                    table.ForeignKey(
                        name: "FK_module_status_modules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_module_status_module_id",
                table: "module_status",
                column: "ModuleId",
                unique: true);
